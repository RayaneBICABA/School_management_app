        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-6">
          <div class="flex items-center gap-6">
            <div class="relative group cursor-pointer" @click="showLightbox = true">
              <div class="size-32 rounded-full border-4 border-slate-100 dark:border-slate-800 overflow-hidden bg-center bg-no-repeat bg-cover shadow-inner flex items-center justify-center bg-white dark:bg-slate-700">
...
const handleDeletePhoto = async () => {
    ...
    try {
        console.log('🗑️ handleDeletePhoto triggered (Admin)');
