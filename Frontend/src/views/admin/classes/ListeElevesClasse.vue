      ...
      <div class="mb-8">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-2">
          ...
          <div class="flex items-center gap-4 flex-1 justify-end">
            ...
            <router-link :to="`/admin/ajouter-utilisateur?role=ELEVE&classe=${classeId}`" class="btn-organic flex items-center justify-center gap-2 px-5 h-11 bg-primary text-white rounded-lg font-bold shadow-md shadow-primary/20 hover:bg-primary/90 text-sm whitespace-nowrap">
...
const voirFicheEleve = (eleve) => {
  router.push(`/admin/classes/${classeId}/eleve/${eleve._id}`)
}
